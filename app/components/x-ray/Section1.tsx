...
const slides = [
  {
    ...
    title: <h1 className="font-sans">High-Quality <span className="text-[#F98D1B]">Digital <br /> X-Ray</span> Services for<br /> Fast and Clear Results</h1>,
    subtitle: <><span className="text-[#1E1E1E] font-dm-sans font-medium">At VJ Scans & Labs, we provide precise and safe X-ray <br /> imaging using the latest digital radiography <br /> technology.  </span></>,
