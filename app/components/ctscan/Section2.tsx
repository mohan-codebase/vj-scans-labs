    ...
    return (
        <section className="font-sans w-full max-w-7xl mx-auto px-2 md:px-0  py-12 md:py-16">
            ...
            <div className="flex justify-center mb-12 md:mb-16">
                <div className="flex flex-col md:flex-row flex-wrap justify-center gap-2 bg-[linear-gradient(90deg,#FFEBD6_0%,#D1EBFF_100%)] rounded-2xl md:rounded-full p-5 md:p-2 w-full md:w-auto">
                    {tabContent.map((tab, index) => (
                        <button
                            key={index}
                            onClick={() => setActiveTab(index)}
                            className={`px-4 py-2 md:px-6 md:py-3 rounded-full text-sm md:text-lg font-[600] w-full md:w-auto ${activeTab === index
                                ? 'bg-[#0961A1] text-white shadow-md'
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-10 lg:gap-16 px-2 md:px-0 lg:px-0">
                ...
                <div className="flex-1 max-w-2xl">
                    <h2
                        className="text-4xl md:text-4xl lg:text-[46px] font-[700]  text-[#0961A1] mb-6"
                        dangerouslySetInnerHTML={{ __html: tabContent[activeTab].title }}
                    />
                    <div className="space-y-6 md:text-lg font-[600] leading-relaxed">
