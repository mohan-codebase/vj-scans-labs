...
const slides = [
  {
    ...
    title: <h1 className="font-sans">Advanced 1.5 Tesla <span className="text-[#F98D1B]"> MRI Scans</span> for Clear and <br /> Accurate Diagnosis</h1>,
    subtitle: <><span className="text-[#1E1E1E] font-dm-sans font-medium">Experience high-definition imaging with our latest 1.5 <br /> Tesla MRI system. We ensure maximum comfort, <br /> minimal noise, and fast reporting all handled by expert <br /> radiologists you can trust. </span></>,
...
const Section1 = () => {
  ...
  }, [page]) // Added page dependency to reset timer on manual change
