            ...
            <section className="w-full max-w-[1600px] mx-auto py-10 md:py-20 px-4 md:px-6 lg:pb-28 font-sans">
                ...
                <div className="flex flex-wrap justify-center  items-center gap-12 mt-12">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <h4 className="font-['DM_Sans'] font-semibold text-xl leading-[25px] text-center mt-4">Chest Pain</h4>
                    </div>
                    <div className="flex flex-col justify-center items-center">
                        <Image className="w-[120px] md:w-[150px]" src={DizzinessIcon} alt="Dizziness" width={120} height={120} />
                        <h4 className="font-['DM_Sans'] font-semibold text-xl leading-[25px] text-center mt-4">Dizziness</h4>
                    </div>
                    <div className="flex flex-col justify-center items-center">
                        <Image className="w-[120px] md:w-[150px]" src={FaintingIcon} alt="Fainting" width={120} height={120} />
                        <h4 className="font-['DM_Sans'] font-semibold text-xl leading-[25px] text-center mt-4">Fainting</h4>
                    </div>
                    <div className="flex flex-col justify-center items-center">
                        <Image className="w-[120px] md:w-[150px]" src={FatigueIcon} alt="Fatigue" width={120} height={120} />
                        <h4 className="font-['DM_Sans'] font-semibold text-xl leading-[25px] text-center mt-4">Fatigue</h4>
                    </div>
             ...
             <div className="flex flex-wrap justify-center  items-center gap-12 mt-12">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <h4 className="font-['DM_Sans'] font-semibold text-xl leading-[25px] text-center mt-4">Heart Racing</h4>
                    </div>
                    <div className="flex flex-col justify-center items-center">
                        <Image className="w-[120px] md:w-[150px]" src={NauseaIcon} alt="Nausea" width={120} height={120} />
                        <h4 className="font-['DM_Sans'] font-semibold text-xl leading-[25px] text-center mt-4">Nausea</h4>
                    </div>
                    <div className="flex flex-col justify-center items-center">
                        <Image className="w-[120px] md:w-[150px]" src={SweatingIcon} alt="Sweating" width={120} height={120} />
                        <h4 className="font-['DM_Sans'] font-semibold text-xl leading-[25px] text-center mt-4">Sweating</h4>
                    </div>
                    <div className="flex flex-col justify-center items-center">
                        <Image className="w-[120px] md:w-[150px]" src={TroublebreathingIcon} alt="Trouble Breathing" width={120} height={120} />
                        <h4 className="font-['DM_Sans'] font-semibold text-xl leading-[25px] text-center mt-4">Trouble Breathing</h4>
                    </div>
                </div>
            </section>
        </div>
