...
const slides = [
    {
        ...
        subtitle: <span className="text-[#1E1E1E] font-secondary font-medium">An Electrocardiogram (ECG) is a quick, simple, and non- <br /> invasive test that measures and records the electrical <br /> activity of your heart.</span>,
