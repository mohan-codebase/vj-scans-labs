    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('/api/contact', {
                ...
                body: JSON.stringify({
                    ...formData,
                    source: 'PGT Page - Get Counseling Form'
                }),
            });
            ...
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="relative rounded-[32px] md:rounded-[48px] lg:rounded-[60px] overflow-hidden min-h-[350px] p-4 md:p-0 md:min-h-[550px] lg:min-h-[600px] w-full flex items-center bg-[#0961A1]">
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage: "url('/images/specialities/male-infertility/section6/get-in-touch.avif')",
                            backgroundSize: 'cover', // Changed to cover for potentially better fit if image reused
                    ...
                    <div
                        className="absolute inset-0 hidden md:block"
                        style={{
                            background: 'linear-gradient(90deg, #0961A1 0%, #0961A1 30%, rgba(9, 97, 161, 0.7) 60%, rgba(9, 97, 161, 0.3) 70%, transparent 100%)'
                        }}
                    />
