...
const column1 = [
    "Real-Time PCR (Polymerase Chain Reaction) for viral load",
    "Next-Generation Sequencing (NGS) for pathogen identification",
    "Serological Assays (IgM/IgG) for antibody detection",
...
const column2 = [
    ...
    "Molecular diagnostics for respiratory pathogens",
    "Advanced vector-borne disease panels",
    "Fungal infection screening markers",
    "Comprehensive sepsis panels"
];
