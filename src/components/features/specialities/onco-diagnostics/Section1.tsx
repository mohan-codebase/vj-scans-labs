...
const slides = [
    {
        id: 1,
        title: <span className='font-sans font-[650] text-[#0961A1]'>Onco <span className='text-[#F98D1B]'>Diagnostics</span></span>,
        subtitle: <span className="text-[#1E1E1E] font-secondary font-medium">
    ...
    return (
        <section className="w-full max-w-[1400px] mx-auto px-3 md:px-0 py-4 lg:py-8 flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="relative z-10 h-full px-6 py-8 lg:p-11 flex flex-col justify-center pointer-events-none">
                            <div className="max-w-lg pointer-events-auto">
                                ...
                                <motion.button
                                    ...
                                    className="bg-[linear-gradient(84.92deg,#F98D1B_34.11%,#FFC180_105.58%)] mb-62 md:mb-6 mt-2 text-sm md:text-base text-white px-5 py-3 md:px-6 md:py-3 rounded-full flex items-center gap-2 hover:bg-[#e07c12] transition-colors shadow-md cursor-pointer w-fit"
                                >
                                    Know More
            ...
            <div className="w-full lg:w-[400px] bg-[linear-gradient(139.05deg,#FFF7EF_0%,#FFEAD4_100%)] rounded-[24px] lg:rounded-[32px] border border-[#E3E3E3] p-6 lg:p-8 flex flex-col justify-center">
                <h2 className="text-[22px] md:text-[27px] font-bold text-[#0961A1] mb-6 md:mb-8 text-center">Book Your Screening</h2>
                <form className="space-y-3 lg:space-y-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <option value="cancer-screening">General Cancer Screening</option>
                            <option value="pet-ct">PET-CT Scan</option>
                            <option value="biopsy">Diagnostic Biopsy</option>
                        </select>
