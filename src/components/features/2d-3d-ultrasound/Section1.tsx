                        ...
                        <div className="relative z-10 h-full px-6 py-8 lg:p-11 flex flex-col justify-center pointer-events-none">
                            <div className="max-w-lg pointer-events-auto">
                                ...
                                <motion.button
                                    ...
                                    className="bg-[linear-gradient(84.92deg,#F98D1B_34.11%,#FFC180_105.58%)] mb-55 lg:mb-26 mt-2 text-sm md:text-base text-white px-2 py-2 md:px-6 md:py-3 rounded-full flex items-center gap-2 hover:bg-[#e07c12] transition-colors shadow-md cursor-pointer w-fit"
                                >
                                    Know More
