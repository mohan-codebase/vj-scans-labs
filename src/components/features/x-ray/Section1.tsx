...
const slides = [
  {
    ...
    subtitle: <span className="text-[#1E1E1E] font-sans font-medium">At VJ Scans & Labs, we provide precise and safe X-ray <br /> imaging using the latest digital radiography <br /> technology.  </span>,
