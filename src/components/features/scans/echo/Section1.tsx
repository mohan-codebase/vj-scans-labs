...
const slides = [
    {
        ...
        subtitle: <span className="text-[#1E1E1E] font-sans font-medium">Gain detailed insights into your heart&apos;s structure and <br /> function with our advanced echocardiography performed <br /> by certified cardiac specialists.</span>,
