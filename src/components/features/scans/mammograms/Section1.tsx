...
const slides = [
    {
        ...
        subtitle: <span className="text-[#1E1E1E] font-sans font-medium text-white">Utilizing advanced digital imaging technology to <br /> deliver precise visuals that support confident, <br /> informed clinical decisions.</span>,
