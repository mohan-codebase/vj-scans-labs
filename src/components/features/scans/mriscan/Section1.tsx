...
const slides = [
    {
        ...
        subtitle: <span className="text-[#1E1E1E] font-sans font-medium">Experience high-definition imaging with our latest 1.5 <br /> Tesla MRI system. We ensure maximum comfort, <br /> minimal noise, and fast reporting all handled by expert <br /> radiologists you can trust. </span>,
        image: "/images/mriscan/section1/mribanner.png",
