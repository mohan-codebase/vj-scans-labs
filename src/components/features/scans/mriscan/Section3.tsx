      ...
      <section className="w-full max-w-[1600px] mx-auto py-10 md:py-20 px-4 md:px-6 lg:pb-28 font-sans">
        ...
        <div className="grid grid-cols-2 gap-6 justify-items-center md:flex md:flex-wrap md:justify-center md:gap-12 mt-12">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <h4 className="font-secondary font-semibold text-xl leading-[25px] text-center mt-4">Cardiac</h4>
          </div>
          <div className="flex flex-col justify-center items-center">
            <Image className="w-[80px] md:w-[150px]" src={SpineIcon} alt="Spinal Scan" width={908} height={816} />
            <h4 className="font-secondary font-semibold text-xl leading-[25px] text-center mt-4">Spinal</h4>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-6 justify-items-center md:flex md:flex-wrap md:justify-center md:gap-12 mt-12">
          <div className="flex flex-col justify-center items-center">
            <Image className="w-[80px] md:w-[150px]" src={AbdomenIcon} alt="Abdomen Scan" width={908} height={816} />
            <h4 className="font-secondary font-semibold text-xl leading-[25px] text-center mt-4">Abdomen</h4>
          </div>
          <div className="flex flex-col justify-center items-center">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <h4 className="font-secondary font-semibold text-xl leading-[25px] text-center mt-4">Spectroscopy</h4>
          </div>
          <div className="flex flex-col justify-center items-center">
            <Image className="w-[80px] md:w-[150px]" src={KneeIcon} alt="Knee Scan" width={908} height={816} />
            <h4 className="font-secondary font-semibold text-xl leading-[25px] text-center mt-4">Knee</h4>
          </div>
