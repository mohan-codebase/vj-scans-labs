...
const testimonialsData = [
    {
        ...
        initial: 'M', // Using M as per image, though name is Ganesh? Maybe it's Mahesh? I'll stick to the visual 'M'
        initialColor: 'bg-[#10a35d]', // Green
    ...
    },
    {
        ...
        name: 'Karthik R',
        initial: 'K',
        initialColor: 'bg-[#10a35d]', // Green placeholder
