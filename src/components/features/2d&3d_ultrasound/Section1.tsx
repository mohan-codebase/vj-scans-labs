...
const slides = [
    {
        ...
        subtitle: <span className="text-[#1E1E1E] font-dm-sans font-medium">Get detailed imaging with our advanced ultrasonography <br /> technology. From pregnancy scans to organ evaluations,<br /> we provide quick, safe, and reliable results performed by <br /> certified sonographers and radiologists.</span>,
        image: "/images/2d&3d_ultrasound/section1/section1.avif",
