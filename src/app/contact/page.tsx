...
export const metadata: Metadata = {
    ...
    description: "Get in touch with VJ Scans & Labs for inquiries, appointments, or genetic counseling support.",
    openGraph: {
        title: "Contact Us - VJ Scans & Labs",
        description: "Get in touch with VJ Scans & Labs for inquiries, appointments, or genetic counseling support.",
        url: `${SITE_NAME}/contact`,
        siteName: SITE_NAME,
        type: "website"
    }
}
...
const ContactPage = () => {
    return (
        <main>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-[#F1F9FF] p-8 rounded-3xl border border-blue-50 flex flex-col items-center text-center gap-4  transition-shadow">
                            ...
                            <p className="text-gray-600 font-medium">
                                <a href="tel:+918098088090" className=" transition-colors">+91 809 808 8090</a>
                            </p>
                        ...
                        <div className="bg-[#FFF8F0] p-8 rounded-3xl border border-orange-50 flex flex-col items-center text-center gap-4 transition-shadow">
                            ...
                            <p className="text-gray-600 font-medium">
                                <a href="mailto:info@vjscans.com" className=" transition-colors">info@vjscans.com</a>
                            </p>
                        </div>
            ...
            <AppointmentSection className='mb-10' />
        </main >
    )
}
