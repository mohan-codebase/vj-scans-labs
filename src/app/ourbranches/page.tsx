...
export const metadata: Metadata = {
    title: seoDatas.ourBranches.title,
            ...
            <section className="py-10 md:py-10 md:mb-10">
                <div className="max-w-[1400px] mx-auto px-4">
                    <div className="grid grid-cols-1 gap-12">
                        {branches.map((branch) => (
                            <ScrollReveal key={branch.id} direction="up" delay={0.2}>
                                <div className="bg-white rounded-[32px] overflow-hidden shadow-xl border border-gray-100 flex flex-col lg:flex-row">
                    ...
                    <ScrollReveal direction="up"><AppointmentSection className='my-14' /></ScrollReveal>
